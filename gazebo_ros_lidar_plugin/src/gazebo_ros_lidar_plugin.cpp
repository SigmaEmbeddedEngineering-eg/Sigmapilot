...
void GazeboRosLiDAR::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf) {
    ...
    this->deferred_load_thread_ = boost::thread(boost::bind(&GazeboRosLiDAR::LoadThread, this));
}
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosLiDAR::LoadThread() {
    ...
    if (this->topic_name_ != "") {
        ros::AdvertiseOptions pcl_ao = ros::AdvertiseOptions::create<PointCloud>(
            "LiDAR" + this->sensor_id + "/pcl", 1000, boost::bind(&GazeboRosLiDAR::LaserConnect, this),
            boost::bind(&GazeboRosLiDAR::LaserDisconnect, this), ros::VoidPtr(), NULL);
    ...
    image_sub_ = this->it_->subscribe(this->cam_topic_name, 1, &GazeboRosLiDAR::imageCb, this);
}
////////////////////////////////////////////////////////////////////////////////
// Camera callback
...
void GazeboRosLiDAR::LaserConnect() {
    ...
    if (this->laser_connect_count_ == 1)
        this->laser_scan_sub_ =
            this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(), &GazeboRosLiDAR::OnScan, this);
}
...
void GazeboRosLiDAR::OnScan(ConstLaserScanStampedPtr &_msg) {
    ...
    (void)this->custom_lidar_.construct_lidar_frame(ranges, cam_feed_, pcl_msg);
